...
# remote tests
cd "$THIS_FOLDER"
bash "test_ssh_to_remote.bash" "$REMOTE_USER" "$REMOTE_HOST" "$SECRET_KEY" "$BACKUP_FOLDER" 

cd "$THIS_FOLDER"
bash "test_sftp_to_remote.bash" "$REMOTE_USER" "$REMOTE_HOST" "$SECRET_KEY" "$BACKUP_FOLDER" 
